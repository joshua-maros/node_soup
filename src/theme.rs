...
pub const NODE_HEADER_HEIGHT: f32 = 30.0;
pub const NODE_MIN_WIDTH: f32 = 140.0;
...
pub const NODE_LABEL_COLOR_BRIGHTNESS: f32 = 0.3;
...
pub const PARAMETER_LABEL_COLOR_BRIGHTNESS: f32 = 1.0;
pub const PARAMETER_LABEL_COLOR_OPACITY: f32 = 1.0;
pub const PARAMETER_LABEL_COLOR: [f32; 4] = [
    PARAMETER_LABEL_COLOR_BRIGHTNESS,
    PARAMETER_LABEL_COLOR_BRIGHTNESS,
    PARAMETER_LABEL_COLOR_BRIGHTNESS,
    PARAMETER_LABEL_COLOR_OPACITY,
];
pub const PARAMETER_LABEL_SIZE: f32 = NODE_LABEL_SIZE;
